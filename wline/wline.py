...
#kaantyy 2 sekunttia 
tank_rotate = tank_pair.on_for_seconds(OUTPUT_B, OUTPUT_C, 2, brake=True, block=False)
...
while True:
    ...
    if (intensity > ridColor): # viivalla
        ...
        tank_rotate.on(-25, 25)  # vasemman ja oikean nopeudet, kääntyy vasemmalle
        tank_rotate.on(25, -25)  # vasemman ja oikean nopeudet, kääntyy oikealle
